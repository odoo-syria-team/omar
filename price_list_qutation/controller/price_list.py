...
class PricelistTemplateFrom(http.Controller):
    @http.route('/new/quotation', auth="user", csrf=False, website=True, methods=['GET', 'POST'])
    def get_document_record(self):
        ...
        if request.httprequest.method == 'POST':
            ...
            try:
                return request.render('price_list_qutation.sale_order_form_create_from_pricelist', {

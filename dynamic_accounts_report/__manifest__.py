...
{
    'name': 'Dynamic Financial Reports V16.0',
    'version': '16.0.1.0.11',
    'category': 'Accounting',
    ...
    'description': "_Dynamic Financial Reports, DynamicFinancialReports, FinancialReport, Accountingreports, odoo reports, odoo"
